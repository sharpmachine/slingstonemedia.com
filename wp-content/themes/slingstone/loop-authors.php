...
<?php
	 ...
	 */ ?>
	  <?php query_posts('showposts=100&post_type=authors&orderby=title&order=asc'); ?>
...
<!--<?php 
		...
		echo $split_name[1];
?>	-->
			<div class="entry-summary author-entry-summary">
				
				<img src="<?php the_field('author_headshot'); ?>" alt="<?php the_title(); ?>" width="125" height="125" class="alignleft">
				<h3 class="author-name"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'twentyten' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h3>
				<?php the_excerpt(); ?>
...
?>	"><img src="<?php bloginfo('template_directory'); ?>/images/books-by-author.png" width="129" height="18" alt="Books By Author"></a>
	...
	<?php else : ?>
			<div class="entry-content">
				<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'twentyten' ) ); ?>ff
