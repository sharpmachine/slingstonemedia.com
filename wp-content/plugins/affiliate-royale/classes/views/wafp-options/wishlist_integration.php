<div class="wafp-options-pane wafp-integration-option wafp-wishlist-option<?php echo $wishlist_class; ?>">
  <p><strong><?php _e('Here are the steps you\'ll need to follow to integrate Affiliate Royale with Wishlist Member when its using PayPal to process payments', 'affiliate-royale'); ?></strong></p>
  ...
  <ol>
    ...
    <li><?php _e('Make Sure "Add advanced variables" is checked in Step 3 and add the following text into the "Advanced Variables" text area underneath your custom variables for Wishlist Member:', 'affiliate-royale'); ?><br/>
